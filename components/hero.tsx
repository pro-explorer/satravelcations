      ...
      <div className="absolute inset-0 flex flex-col justify-center px-8 py-8 text-slate-50 sm:px-16">
        <div className="mx-auto w-full max-w-screen-xl px-4 py-8 text-center lg:px-12 lg:py-16">
          ...
          <div className="mb-8 flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-x-4 sm:space-y-0 lg:mb-16">
            ...
            <Link
              href="/search"
              className=" items-center justify-center inline-flex rounded-lg border-2 border-white bg-transparent px-8 py-3 text-lg font-semibold text-white transition duration-300 hover:bg-white hover:text-blue-600"
            >
